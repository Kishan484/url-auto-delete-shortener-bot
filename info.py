...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001913960805')).split()]
...
SELF_DELETE_SECONDS = int(environ.get('SELF_DELETE_SECONDS', 9000))
